  ...
  if (Res.id)
    return (
      <>
          ...
          <HStack style={{ position: "absolute", top: "85%", left: "65%" }}>
            <Button
              style={{
                ...
                borderRadius: "50%",
                marginRight: "10px",
                boxShadow: "4px 5px 7px -5px rgba(97,90,90,0.84)",
              }}
            >
              <Ionicons color="#e32207" name="people" size={30} />
            </Button>
            <Button
              style={{
                backgroundColor: "white",
            ...
            >
              <Ionicons color="#e32207" name="headset-outline" size={30} />
            </Button>
          </HStack>
        </View>
        ...
        >
          <Text style={{ fontWeight: "bold" }}> {Res.ResName} </Text>
          <HStack>
            <Star
              score={Number(Res.Rate)}
              style={{ width: "80", height: "15" }}
            />
            <Text>
              <Text
                style={{ textDecorationLine: "underline", color: "#6E7570" }}
              >
                4.5 Rating
              </Text>
            </Text>
          ...
          <Text style={{ color: "#6E7570" }}> {Res.Type + ","}</Text>
        ...
        <View style={{ marginLeft: "5px", marginBottom: "10px" }}>
          ...
          >
            ...
            <Text style={{ color: "#6E7570" }}>
              {" "}
              Discount on orders above 140 EGP. Expires in 16 days{" "}
            </Text>
          </Box>
          ...
          <HStack>
            ...
            <HStack style={{ marginLeft: "auto" }}>
              <CircleIcon
                size={4}
                color="#3bc93a"
                style={{ paddingRight: 6, marginTop: "2px" }}
              />
